...
public class Program {
    ...
    private static void removeAnimals(Zoo animal, Scanner input) {
        animal.showAll();
    ...
    private static void infoAnimals(Zoo animal, Scanner input) {
        animal.showAll();
        System.out.printf("%d) Назад\n", Zoo.sayAllAnimals.size());
        System.out.print("Введите цифру того, кого хотите посмотреть: ");
        int choice = input.nextInt();
        if (choice < Zoo.sayAllAnimals.size()) {
    ...
    private static void sayAnimals(Zoo animal, Scanner input) {
        animal.showAll();
        System.out.printf("%d) Назад\n", Zoo.allAnimals.size());
        System.out.print("Введите цыфру того, кто кто должен произнести звук: ");
        int choice = input.nextInt();
        if (choice < Zoo.allAnimals.size()) {
